      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="text-xl font-semibold text-white ml-2 tracking-wider">ISIMBI</span>
          </div>
      ...
      <section className="container mx-auto px-4 py-20 md:py-32 flex flex-col items-center justify-center text-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight mb-6">
            ISIMBI — <span className="text-isimbi-purple">Intelligent Security</span>, Built for the New Era
          </h1>
